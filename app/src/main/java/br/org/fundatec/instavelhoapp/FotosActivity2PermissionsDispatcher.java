...
class FotosActivity2PermissionsDispatcher {
    ...
    private FotosActivity2PermissionsDispatcher() {
    }

    static void dispatchTakePictureIntentWithCheck(FotosActivity2 target) {
    ...
    static void onRequestPermissionsResult(FotosActivity2 target, int requestCode, int[] grantResults) {
        switch (requestCode) {
